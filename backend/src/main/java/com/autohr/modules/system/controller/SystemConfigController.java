...
public class SystemConfigController {
    ...
    private static final String[] CONFIG_KEYS = {
            ...
            "SCHOOL_LLM_BASE_URL", "SCHOOL_LLM_API_KEY", "SCHOOL_LLM_MODEL", "SCHOOL_LLM_DEFAULT_PROMPT", "SCHOOL_LLM_INTERVIEWER_PROMPT", "SCHOOL_LLM_SCORER_PROMPT", "SCHOOL_LLM_SUMMARY_PROMPT", "LLM_ALLOW_PRIVATE_ADDRESSES",
    ...
    private static final Set<String> RETAIN_ON_BLANK_KEYS = Set.of(
            ...
            "ALIYUN_STT_ACCESS_KEY_SECRET", "DB_PASSWORD", "JWT_SECRET", "INTERVIEW_TURN_SHARED_SECRET", "SCHOOL_LLM_API_KEY"
    );
    ...
    private void maskSecrets(Map<String, String> config) {
        ...
        mask(config, "SCHOOL_LLM_API_KEY");
    }
